        ...
        try:
            while True:
                ...
                for c in range(eeg_channel_count):
                    if delta:
                        dMean += np.mean(self.filter(data[eeg_channels[c]], self.delta_waves.lower, self.delta_waves.upper, self.wf))
                    if theta:
                        tMean += np.mean(self.filter(data[eeg_channels[c]], self.theta_waves.lower, self.theta_waves.upper, self.wf))
                    if alpha:
                        aMean += np.mean(self.filter(data[eeg_channels[c]], self.alpha_waves.lower, self.alpha_waves.upper, self.wf))
                    if beta:
                        bMean += np.mean(self.filter(data[eeg_channels[c]], self.beta_waves.lower, self.beta_waves.upper, self.wf))
                    if gamma:
                        gMean += np.mean(self.filter(data[eeg_channels[c]], self.gamma_waves.lower, self.gamma_waves.upper, self.wf))
